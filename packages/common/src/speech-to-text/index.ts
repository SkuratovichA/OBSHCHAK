...
export const speechToText = async (audioBlob: ArrayBuffer, apiKey: string): Promise<string | undefined> => {
  const formData = new FormData()
  formData.append('file', audioBlob, 'audio.wav')
  formData.append('model', OPENAI_STT_MODEL)
  formData.append('prompt', `English language, English speech, kitchen appliances, galbe, oven, coup de feu, `)
