...
const DescriptionFieldSkeleton: React.FC = () => <Skeleton variant="text" width="20ch" height="3rem" />

type DescriptionFieldProps = Loadable<{
  description: string
} & TypographyProps>

export const DescriptionField: React.FC<DescriptionFieldProps> = ({ isLoading, description, ...props }) =>
  isLoading
